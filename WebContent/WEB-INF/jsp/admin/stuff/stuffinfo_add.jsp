...
<div class="place">
    ...
    <form action="admin/stuff/save" method="post">
    <input type="hidden" name="locked" value="0" />
    <ul class="forminfo">
    <li><label>员工姓名<b>*</b></label><input name="name" type="text" class="dfinput"  style="width:518px;"/></li>
    ...
    <li><label>办公电话<b>*</b></label><input name="tele" type="text" class="dfinput"  style="width:518px;"/></li>
    <li><label>手机账号<b>*</b></label><input name="phone" type="text" class="dfinput"  style="width:518px;"/></li>
