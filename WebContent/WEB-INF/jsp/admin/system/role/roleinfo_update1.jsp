	...
	<form action="admin/role/saveUpdate" method="post" class="form form-horizontal" id="form-admin-update">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="${role.name}"  placeholder="" id="user-tel" name="name"  datatype="*2-16" >
			</div>
			<div class="col-4"> </div>
		</div>
...
$(function(){
	...
	$("#form-admin-update").Validform({
		...
		callback:function(){
			...
			$.ajax({
				url: "admin/system/role/saveUpdate",
				type: 'POST',
...
$("#level option[value='${role.level}']").attr("selected","selected");
$("#deptment option[value='${role.deptId}']").attr("selected","selected");
