...
<div class="pd-20">
	...
	<a href="javascript:;" onclick="member_add('添加用户','admin/stuff/add','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加用户</a>
	</span> 
	</c:if>
	<span class="r">共有数据：<strong>${stuffPager.totalCount } </strong> 条</span> </div>
	<div class="mt-20">
		...
		<tbody>
		    <c:forEach items="${stuffPager.dataList}" var="c">
				<tr class="text-c">
					...
					<td class="td-manage">
					<a title="编辑" href="javascript:;" onclick="member_edit('编辑','admin/stuff/update','${c.id }','','510')" class="ml-5" style="text-decoration:none"><span class="btn btn-link">编辑</span></a>
