...
<body>
<div class="pd-20">
	<form action="admin/stuff/saveUpdate" method="post" class="form form-horizontal" id="form-admin-update">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="${stuff.tele}" placeholder="" id="user-tel" name="tele"  datatype="*" nullmsg="办公电话不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="${stuff.phone}" placeholder="" id="user-tel" name="phone"  datatype="m" nullmsg="手机账号不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
