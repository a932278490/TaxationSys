	...
	<form action="admin/vehicle/saveUpdate" method="post" class="form form-horizontal" id="form-admin-update">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="${vehicle.licence}" placeholder="" id="user-name" name="licence" datatype="*2-16" nullmsg="车牌号不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="" placeholder="密码" autocomplete="off" value="${vehicle.capacity }" class="input-text" datatype="n" nullmsg="请输入数字" name="capacity">
			</div>
			<div class="col-4"> </div>
		</div>
