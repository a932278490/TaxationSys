...
public interface MessageService {
	 ...
	 */
	public Pager<Message> queryPage(Map<String,Object> condition,Integer currentPage,Integer pageSize,String orderBy,String sortBy);
	
	/**
	 * 根据fromStuff发送toStuff内容为content的信息
	 * @param fromStuff 发送者
	 * @param toStuff 发送人
	 * @param content 内容
	 */
