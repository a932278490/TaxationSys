...
<body>
<div class="pd-20">
	<form action="admin/deptment/save" method="post" class="form form-horizontal" id="form-admin-add">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-5">
				<input type="text" class="input-text" value="${deptment.charge}" placeholder="" id="user-tel" name="charge"  datatype="*" nullmsg="手机不能为空">
			</div>
			<div class="col-4"> </div>
		</div>
