...
<div class="place">
    ...
    <div class="itab">
  	<ul> 
    <li><a href="#tab1" class="selected">填写员工信息</a></li> 
    ...
    <ul class="forminfo">
    <li><label>员工姓名<b>*</b></label><input name="name" value="${stuff.name }" type="text" class="dfinput"  style="width:518px;"/></li>
    ...
    <li><label>办公电话<b>*</b></label><input name="tele" value="${stuff.tele}" type="text" class="dfinput"  style="width:518px;"/></li>
    <li><label>手机账号<b>*</b></label><input name="phone" value="${stuff.phone}" type="text" class="dfinput"  style="width:518px;"/></li>
    <li><label>密码<b>*</b></label><input name="password" value="${stuff.password}" type="text" class="dfinput"  style="width:518px;"/></li>
    <li><label>所属用户组<b>*</b></label>  
	    <div class="vocation">
