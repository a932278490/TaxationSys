...
<div class="pd-20">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="member_add('添加用户','admin/system/role/add','','510')" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加角色</a></span> <span class="r">共有数据：<strong>${rolePager.totalCount } </strong> 条</span> </div>
	<div class="mt-20">
		...
		<tbody>
		    <c:forEach items="${rolePager.dataList}" var="c">
				<tr class="text-c">
					...
					<td class="td-manage">
				<%-- 	<a style="text-decoration:none" onClick="member_start(this,'${c.id }')" href="javascript:;" title="停用"><span class="btn btn-link">更改状态</span></a>  --%>
					<a title="编辑" href="javascript:;" onclick="member_edit('编辑','admin/system/role/update','${c.id }','','510')" class="ml-5" style="text-decoration:none"><span class="btn btn-link">编辑</span></a> 
					...
					<td class="td-manage">
					<%-- <a style="text-decoration:none" onClick="member_stop(this,'${c.id }')" href="javascript:;" title="停用"><span class="btn btn-link">更改状态</span></a> --%>
					<a title="编辑" href="javascript:;" onclick="member_edit('编辑','admin/system/role/update','${c.id }','','510')" class="ml-5" style="text-decoration:none"><span class="btn btn-link">编辑</span></a>
					<!--  <a style="text-decoration:none" class="ml-5" onClick="change_password('修改密码','change-password.html','10001','600','270')" href="javascript:;" title="修改密码"><i class="Hui-iconfont">&#xe63f;</i></a>-->
					<a title="删除" href="javascript:;" onclick="member_del(this,'${c.id }')" class="ml-5" style="text-decoration:none"><span class="btn btn-link">删除</span></a></td>
					</c:if>
