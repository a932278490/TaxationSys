...
<div class="place">
    ...
    <form action="admin/deptment/saveUpdate" method="post">
    <input type="hidden" value="${deptment.id}" name="id" />
    <ul class="forminfo">
    <li><label>部门名称<b>*</b></label><input name="name" value="${deptment.name }" type="text" class="dfinput"  style="width:518px;"/></li>
